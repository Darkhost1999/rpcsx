...
void Emulator::FinalizeRunRequest()
{
	...
	rx::BitSet<cpu_flag> add_flags = cpu_flag::dbg_global_pause;
	...
	{
		rx::BitSet<cpu_flag> sub_flags = cpu_flag::stop;
				...
				named_thread emu_state_cap_thread("Emu State Capture Thread", [&]()
					{
						...
						rx::BitSet<SaveStateExtentionFlags1> extension_flags{SaveStateExtentionFlags1::SupportsMenuOpenResume};
