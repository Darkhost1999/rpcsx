...
struct spu_exec_select
{
	...
	static spu_intrp_func_t select(rx::BitSet<spu_exec_bit> selected, F func)
	{
	...
	template <typename F>
	static spu_intrp_func_t select(rx::BitSet<spu_exec_bit>, F func)
	{
...
spu_interpreter_rt_base::spu_interpreter_rt_base() noexcept
{
	...
	rx::BitSet<spu_exec_bit> selected{};
