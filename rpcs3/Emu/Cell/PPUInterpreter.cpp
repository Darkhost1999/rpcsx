...
struct ppu_exec_select
{
	...
	static ppu_intrp_func_t select(rx::BitSet<ppu_exec_bit> selected, F func)
	{
	...
	template <typename F>
	static ppu_intrp_func_t select(rx::BitSet<ppu_exec_bit>, F func)
	{
	...
	static auto select()
	{
		...
		return [](rx::BitSet<ppu_exec_bit> selected, auto func)
		{
...
{
	template <ppu_exec_bit... Flags>
	static auto select(rx::BitSet<ppu_exec_bit> selected, auto func)
	{
...
ppu_interpreter_rt_base::ppu_interpreter_rt_base() noexcept
{
	...
	rx::BitSet<ppu_exec_bit> selected{};
